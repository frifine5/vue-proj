        ...
        <div class="wrap">
            <div class="top">
                <div class="center-width">
                    ...
                    <div class="query-box">
                        <span>盖章时间</span>
                        <DatePicker :value="searchParams.queryTime" :editable="dateEditable" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 300px" placeholder="请选择盖章时间" @on-change="(value) => {searchParams.queryTime=value}"></DatePicker>
                    </div>
                    <div class="query-box">
                        <Button type="primary" class="btn" @click="myQuery">查询</Button>
                    </div>
                </div>
            </div>
            <div class="content">
