...
/* seal */
const sealApply = () => import('@/pages/seal/apy/SealApply')
const sealManage = () => import('@/pages/seal/mg/SealManage')
...
/* 申请流程 页*/
const apyUnit = () => import('@/pages/seal/apy/ApyUnit')
const apySeals = () => import('@/pages/seal/apy/ApySeals')
const apyPreSub = () => import('@/pages/seal/apy/ApyPreSub')
    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        {
                            path: '/seal/apy/apyUnit',
                            name: 'apyUnit',
                            component: apyUnit
                        },
                        {
                            path: '/seal/apy/apySeals',
                            name: 'apySeals',
                            component: apySeals
                        },
                        {
                            path: '/seal/apy/apyPreSub',
                            name: 'apyPreSub',
                            component: apyPreSub
                        },
